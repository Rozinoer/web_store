    ...
    <div class="row">
        <div class="col">
            <div class="content">
                ...
                $pr= mysqli_query($db,"UPDATE product_info SET
                                                name = '$name', model = '$model',color = '$color', cost = '$cost',
                                                product_code = '$code', processor = '$processor', screen = '$screen',
                                                amount = '$amount', memory = '$memory', os = '$os' 
                                                WHERE product_code ='$code'");
                if ($pr)
                    echo "<a href= \".\add_form.php?\">Данные обновлены!</a>";
                else
                    echo "<a href= \".\re_form.php?\">Ошибка. Вернуться назад</a>";
                ?>
                <br>
                <a href = "../re_form.php">Назад</a>
            </div>
        </div>
    </div>
</div>
